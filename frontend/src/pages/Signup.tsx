    ...
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <BlurFade>
        <div className="w-full max-w-md mx-4 bg-white/[0.05] backdrop-blur-2xl border border-white/[0.1] rounded-2xl p-8 relative z-10">
          ...
          <h1 className="text-2xl font-heading font-bold text-center mb-2 text-foreground">Create your account</h1>
          <p className="text-muted-foreground text-center mb-8">Start analyzing data in minutes</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-sm text-secondary-foreground mb-1.5 block">Confirm Password</label>
