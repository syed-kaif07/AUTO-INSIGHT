...
import { Brain, Mail, Lock, User, Chrome, Github } from 'lucide-react';
        ...
        <div className="min-h-screen bg-bg-primary flex items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-bg-card border border-border rounded-2xl p-8">
                    ...
                    <h1 className="text-2xl font-semibold font-[family-name:var(--font-heading)] text-center mb-2">Create your account</h1>
                    <p className="text-text-muted text-sm text-center mb-8">Start analyzing data with AI agents</p>
